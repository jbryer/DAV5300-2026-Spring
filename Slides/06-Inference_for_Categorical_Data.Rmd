...
omp <- omp |> dplyr::filter(`Class Date` == 'Foundation for Inference')
```
...
.pull-left[
You each have been given a dice and worksheet. 

Roll your die at least 30 times recording the number you roll.

When you are done, scan the QR code to enter your totals.
]
.pull-right[
```{r, echo=FALSE, fig.width=5, fig.height=5}
dice_link <- 'https://forms.gle/84HD73KZe9qcZo5CA'
qrcode::qr_code(dice_link) |> plot(col = c('#FAFAFA', 'black'))
```
]
